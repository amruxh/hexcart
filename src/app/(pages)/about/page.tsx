    ...
    <>
      <section className="px-4 py-10 max-w-4xl min-h-screen mx-auto space-y-10">
        <h2 className="text-center text-3xl sm:text-4xl font-bold text-[var(--foreground)] mb-6">
          HEXCART — Your next-gen Shopping Experience.
        </h2>

        <p className="text-center text-[var(--foreground-muted)] text-base sm:text-lg leading-relaxed max-w-3xl mx-auto">
          HEXCART isn’t just a marketplace — it’s a beacon for those who seek clarity and quality in every purchase. We believe shopping should be simple, bright, and inspiring. From handpicked collections to effortless browsing, HEXCART lights the way to your next favorite find. Rooted in trust and designed for the modern shopper, our mission is to bring you products that brighten your life and elevate your everyday. Discover a shopping experience that shines as brightly as you do.
        </p>
