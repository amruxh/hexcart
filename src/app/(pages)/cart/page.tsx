          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-[30%] p-3">
              <div className="bg-[var(--card-background)] border border-[var(--border)] p-5 rounded-xl shadow sticky top-24">
                ...
                <button
                  onClick={clearCart}
                  className="mt-4 inline-block w-full text-center px-5 py-2 rounded-full bg-[var(--foreground)] hover:bg-[var(--card-background)] hover:text-[var(--foreground)] border border-[var(--border)] text-[var(--background)] cursor-pointer font-bold shadow-md transition duration-200"
                >
                  Clear cart
                </button>
