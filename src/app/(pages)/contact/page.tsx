        ...
        <section className="px-4 py-10 sm:px-8 lg:px-20">
            ...
            <div className="max-w-2xl mx-auto mt-12 border-t border-t-[var(--border)] pt-10">
                ...
                <a
                    ...
                    className="block text-center text-blue-300 hover:underline mb-4"
                >
                    Visit My Portfolio
                </a>
                <div className="flex justify-center gap-4 text-gray-600 dark:text-gray-300 text-lg">
                    <a href="https://github.com/Me-amruth" target="_blank" rel="noopener noreferrer">
                        <Github className="hover:text-black dark:hover:text-white transition" />
                    </a>
